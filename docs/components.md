...
- `index.ts`: Application entry point. Wires up `llamaindex` settings, creates embedding and LLM clients, runs the scraper, indexes the scraped content, and opens a chat-style query against the index.
